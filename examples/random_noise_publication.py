...
run_gaussian_dataset_montecarlo(iterations=100, m=10000, n=128, param_list=None, validation_split=0.2,
                                ...
                                polar=False, do_all=True, dropout=None, tensorboard=False)
